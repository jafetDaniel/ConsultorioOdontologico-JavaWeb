...
<%
    ...
    String nombre_usuario = (String) misession.getAttribute("nombre_usuario"); //obtener valor de la sesion
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <%@include file="sidebar_odonto.jsp"%>
        <% }else if (rol.equals("secretario")) { %>
        <%@include file="sidebar_secre.jsp"%>
        <% } %>
        <!-- End of Sidebar -->
